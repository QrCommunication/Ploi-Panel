...
**231 opérations documentées**, 230 pages avec routes, 231 pages de référence API ; **0 non implémentées** (`not_implemented`), **231 implémentées et testées localement mais non vérifiées sur compte réel** (`implemented_locally_unverified_live`). Ce tableau inventorie la documentation, et ne constitue ni une preuve de disponibilité dans un compte donné, ni un contrat testé contre l’API. Le [JSON](api-coverage.json) conserve chaque entrée et la classification de toutes les URL du sitemap.
...
| `scripts` | `GET` | `/api/scripts` | [List all scripts](https://developers.ploi.io/scripts/list-scripts) | `implemented_locally_unverified_live` |
| `scripts` | `POST` | `/api/scripts` | [Create a script](https://developers.ploi.io/scripts/create-script) | `implemented_locally_unverified_live` |
| `scripts` | `GET` | `/api/scripts/{script}` | [Get a script](https://developers.ploi.io/scripts/get-script) | `implemented_locally_unverified_live` |
| `scripts` | `PATCH` | `/api/scripts/{script}` | [Update a script](https://developers.ploi.io/scripts/update-script) | `implemented_locally_unverified_live` |
| `scripts` | `DELETE` | `/api/scripts/{script}` | [Delete a script](https://developers.ploi.io/scripts/delete-script) | `implemented_locally_unverified_live` |
...
| `status-pages` | `GET` | `/api/status-pages` | [List status pages](https://developers.ploi.io/status-pages/list-status-pages) | `implemented_locally_unverified_live` |
| `status-pages` | `GET` | `/api/status-pages/{statusPage}` | [Get status page](https://developers.ploi.io/status-pages/get-status-page) | `implemented_locally_unverified_live` |
...
| `projects` | `GET` | `/api/projects` | [List all projects](https://developers.ploi.io/projects/list-projects) | `implemented_locally_unverified_live` |
| `projects` | `POST` | `/api/projects` | [Create a project](https://developers.ploi.io/projects/create-project) | `implemented_locally_unverified_live` |
| `projects` | `GET` | `/api/projects/{project}` | [Get a project](https://developers.ploi.io/projects/get-project) | `implemented_locally_unverified_live` |
| `projects` | `PATCH` | `/api/projects/{project}` | [Update a project](https://developers.ploi.io/projects/update-project) | `implemented_locally_unverified_live` |
| `projects` | `DELETE` | `/api/projects/{project}` | [Delete a project](https://developers.ploi.io/projects/delete-project) | `implemented_locally_unverified_live` |
...
| `network-rules` | `GET` | `/api/servers/{server}/network-rules` | [List all network rules](https://developers.ploi.io/network-rules/list-network-rules) | `implemented_locally_unverified_live` |
| `network-rules` | `POST` | `/api/servers/{server}/network-rules` | [Create a network rule](https://developers.ploi.io/network-rules/create-network-rule) | `implemented_locally_unverified_live` |
| `network-rules` | `GET` | `/api/servers/{server}/network-rules/{id}` | [Get a network rule](https://developers.ploi.io/network-rules/get-network-rule) | `implemented_locally_unverified_live` |
| `network-rules` | `DELETE` | `/api/servers/{server}/network-rules/{id}` | [Delete a network rule](https://developers.ploi.io/network-rules/delete-network-rule) | `implemented_locally_unverified_live` |
...
| `services` | `POST` | `/api/servers/{server}/services/{service}/restart` | [Restart a service](https://developers.ploi.io/services/restart-service) | `implemented_locally_unverified_live` |
| `services` | `POST` | `/api/servers/{server}/services/{service}/reload` | [Reload a service](https://developers.ploi.io/services/reload-service) | `implemented_locally_unverified_live` |
| `services` | `POST` | `/api/servers/{server}/install/wp-cli` | [Install WordPress CLI](https://developers.ploi.io/services/install-wordpress-cli) | `implemented_locally_unverified_live` |
| `services` | `POST` | `/api/servers/{server}/wp-cli/run` | [Run a WP CLI command](https://developers.ploi.io/services/run-wp-cli-command) | `implemented_locally_unverified_live` |
| `services` | `DELETE` | `/api/servers/{server}/uninstall/wp-cli` | [Uninstall WordPress CLI](https://developers.ploi.io/services/uninstall-wordpress-cli) | `implemented_locally_unverified_live` |
| `php` | `POST` | `/api/servers/{server}/refresh-opcache` | [Refresh OPcache](https://developers.ploi.io/php/refresh-opcache) | `implemented_locally_unverified_live` |
| `php` | `POST` | `/api/servers/{server}/enable-opcache` | [Enable OPcache](https://developers.ploi.io/php/enable-opcache) | `implemented_locally_unverified_live` |
| `php` | `DELETE` | `/api/servers/{server}/disable-opcache` | [Disable OPcache](https://developers.ploi.io/php/disable-opcache) | `implemented_locally_unverified_live` |
| `php` | `GET` | `/api/servers/{server}/php/versions` | [Get installed PHP versions](https://developers.ploi.io/php/installed-php-versions) | `implemented_locally_unverified_live` |
| `php` | `POST` | `/api/servers/{server}/php/install` | [Install PHP version](https://developers.ploi.io/php/install-php-version) | `implemented_locally_unverified_live` |
| `php` | `POST` | `/api/servers/{server}/php/cli-version` | [Switch PHP CLI version](https://developers.ploi.io/php/switch-php-cli-version) | `implemented_locally_unverified_live` |
| `ssh-keys` | `GET` | `/api/servers/{server}/ssh-keys` | [List all SSH keys](https://developers.ploi.io/ssh-keys/list-ssh-keys) | `implemented_locally_unverified_live` |
| `ssh-keys` | `POST` | `/api/servers/{server}/ssh-keys` | [Create a new SSH key](https://developers.ploi.io/ssh-keys/create-ssh-key) | `implemented_locally_unverified_live` |
| `ssh-keys` | `GET` | `/api/servers/{server}/ssh-keys/{sshKey}` | [Get an SSH key](https://developers.ploi.io/ssh-keys/get-ssh-key) | `implemented_locally_unverified_live` |
| `ssh-keys` | `DELETE` | `/api/servers/{server}/ssh-keys/{sshKey}` | [Delete an SSH key](https://developers.ploi.io/ssh-keys/delete-ssh-key) | `implemented_locally_unverified_live` |
| `load-balancers` | `PATCH` | `/api/servers/{server}/load-balancer/attach` | [Attach server](https://developers.ploi.io/load-balancers/attach-server) | `implemented_locally_unverified_live` |
| `load-balancers` | `PATCH` | `/api/servers/{server}/load-balancer/detach` | [Detach server](https://developers.ploi.io/load-balancers/detach-server) | `implemented_locally_unverified_live` |
| `load-balancers` | `POST` | `/api/servers/{server}/load-balancer/{domain}/request-certificate` | [Request certificate](https://developers.ploi.io/load-balancers/request-certificate-for-domain) | `implemented_locally_unverified_live` |
| `load-balancers` | `DELETE` | `/api/servers/{server}/load-balancer/{domain}/revoke-certificate` | [Revoke certificate](https://developers.ploi.io/load-balancers/revoke-certificate-for-domain) | `implemented_locally_unverified_live` |
| `insights` | `GET` | `/api/servers/{server}/insights` | [List all insights](https://developers.ploi.io/insights/list-insights) | `implemented_locally_unverified_live` |
| `insights` | `GET` | `/api/servers/{server}/insights/{id}` | [Get an insight](https://developers.ploi.io/insights/get-insight) | `implemented_locally_unverified_live` |
| `insights` | `GET` | `/api/servers/{server}/insights/{id}/detail` | [Get insight details](https://developers.ploi.io/insights/detail-insight) | `implemented_locally_unverified_live` |
| `insights` | `POST` | `/api/servers/{server}/insights/{id}/automatically-fix` | [Automatically fix insight](https://developers.ploi.io/insights/automatically-fix-insight) | `implemented_locally_unverified_live` |
| `insights` | `POST` | `/api/servers/{server}/insights/{id}/ignore` | [Ignore insight](https://developers.ploi.io/insights/ignore-insight) | `implemented_locally_unverified_live` |
| `insights` | `DELETE` | `/api/servers/{server}/insights/{id}` | [Delete insight](https://developers.ploi.io/insights/delete-insight) | `implemented_locally_unverified_live` |
...
| `queue-workers` | `GET` | `/api/servers/{server}/sites/{id}/queues` | [Get all queue workers](https://developers.ploi.io/queue-workers/list-queue-workers) | `implemented_locally_unverified_live` |
| `queue-workers` | `POST` | `/api/servers/{server}/sites/{id}/queues` | [Create queue worker](https://developers.ploi.io/queue-workers/create-queue-worker) | `implemented_locally_unverified_live` |
| `queue-workers` | `GET` | `/api/servers/{server}/sites/{id}/queues/{queueId}` | [Get queue worker](https://developers.ploi.io/queue-workers/get-queue-worker) | `implemented_locally_unverified_live` |
| `queue-workers` | `POST` | `/api/servers/{server}/sites/{id}/queues/{queueId}/restart` | [Restart queue worker](https://developers.ploi.io/queue-workers/restart-queue-worker) | `implemented_locally_unverified_live` |
| `queue-workers` | `POST` | `/api/servers/{server}/sites/{id}/queues/{queueId}/toggle-pause` | [Toggle pause](https://developers.ploi.io/queue-workers/pause-queue-worker) | `implemented_locally_unverified_live` |
| `queue-workers` | `DELETE` | `/api/servers/{server}/sites/{id}/queues/{queueId}` | [Delete queue worker](https://developers.ploi.io/queue-workers/delete-queue-worker) | `implemented_locally_unverified_live` |
| `redirects` | `GET` | `/api/servers/{server}/sites/{site}/redirects` | [Get all redirects](https://developers.ploi.io/redirects/list-redirects) | `implemented_locally_unverified_live` |
| `redirects` | `POST` | `/api/servers/{server}/sites/{site}/redirects` | [Create redirect](https://developers.ploi.io/redirects/create-redirect) | `implemented_locally_unverified_live` |
| `redirects` | `GET` | `/api/servers/{server}/sites/{site}/redirects/{redirect}` | [Get redirect](https://developers.ploi.io/redirects/get-redirect) | `implemented_locally_unverified_live` |
| `redirects` | `DELETE` | `/api/servers/{server}/sites/{site}/redirects/{redirect}` | [Delete redirect](https://developers.ploi.io/redirects/delete-redirect) | `implemented_locally_unverified_live` |
| `certificates` | `GET` | `/api/servers/{server}/sites/{site}/certificates` | [Get all certificates](https://developers.ploi.io/certificates/list-certificates) | `implemented_locally_unverified_live` |
| `certificates` | `POST` | `/api/servers/{server}/sites/{site}/certificates` | [Create certificate](https://developers.ploi.io/certificates/create-certificate) | `implemented_locally_unverified_live` |
| `certificates` | `GET` | `/api/servers/{server}/sites/{site}/certificates/{certificate}` | [Get certificate](https://developers.ploi.io/certificates/get-certificate) | `implemented_locally_unverified_live` |
| `certificates` | `GET` | `/api/servers/{server}/sites/{site}/certificates/{certificate}/download` | [Download certificate](https://developers.ploi.io/certificates/download-certificate) | `implemented_locally_unverified_live` |
| `certificates` | `POST` | `/api/servers/{server}/sites/{site}/certificates/{certificate}/activate` | [Activate certificate](https://developers.ploi.io/certificates/activate-certificate) | `implemented_locally_unverified_live` |
| `certificates` | `DELETE` | `/api/servers/{server}/sites/{site}/certificates/{certificate}` | [Delete certificate](https://developers.ploi.io/certificates/delete-certificate) | `implemented_locally_unverified_live` |
| `auth-users` | `GET` | `/api/servers/{server}/sites/{id}/auth-users` | [List all auth users](https://developers.ploi.io/auth-users/list-auth-users) | `implemented_locally_unverified_live` |
| `auth-users` | `POST` | `/api/servers/{server}/sites/{id}/auth-users` | [Create an auth user](https://developers.ploi.io/auth-users/create-auth-user) | `implemented_locally_unverified_live` |
| `auth-users` | `GET` | `/api/servers/{server}/sites/{id}/auth-users/{authUserId}` | [Get an auth user](https://developers.ploi.io/auth-users/get-auth-user) | `implemented_locally_unverified_live` |
| `auth-users` | `DELETE` | `/api/servers/{server}/sites/{id}/auth-users/{authUserId}` | [Delete an auth user](https://developers.ploi.io/auth-users/delete-auth-user) | `implemented_locally_unverified_live` |
| `aliases` | `GET` | `/api/servers/{server}/sites/{site}/aliases` | [List all aliases](https://developers.ploi.io/aliases/list-aliases) | `implemented_locally_unverified_live` |
| `aliases` | `POST` | `/api/servers/{server}/sites/{site}/aliases` | [Create aliases](https://developers.ploi.io/aliases/create-alias) | `implemented_locally_unverified_live` |
| `aliases` | `DELETE` | `/api/servers/{server}/sites/{site}/aliases/{alias}` | [Delete an alias](https://developers.ploi.io/aliases/delete-alias) | `implemented_locally_unverified_live` |
| `tenants` | `GET` | `/api/servers/{server}/sites/{site}/tenants` | [List all tenants](https://developers.ploi.io/tenants/list-tenants) | `implemented_locally_unverified_live` |
| `tenants` | `POST` | `/api/servers/{server}/sites/{site}/tenants` | [Create a tenant](https://developers.ploi.io/tenants/create-tenant) | `implemented_locally_unverified_live` |
| `tenants` | `DELETE` | `/api/servers/{server}/sites/{site}/tenants/{tenant}` | [Delete a tenant](https://developers.ploi.io/tenants/delete-tenant) | `implemented_locally_unverified_live` |
| `tenants` | `POST` | `/api/servers/{server}/sites/{site}/tenants/{tenant}/request-certificate` | [Request a certificate](https://developers.ploi.io/tenants/request-certificate) | `implemented_locally_unverified_live` |
| `tenants` | `POST` | `/api/servers/{server}/sites/{site}/tenants/{tenant}/revoke-certificate` | [Revoke a certificate](https://developers.ploi.io/tenants/delete-certificate) | `implemented_locally_unverified_live` |
| `tenants` | `GET` | `/api/servers/{server}/sites/{site}/tenants/{tenant}/nginx-configuration` | [Get NGINX configuration](https://developers.ploi.io/tenants/get-nginx-configuration-tenant) | `implemented_locally_unverified_live` |
| `tenants` | `PATCH` | `/api/servers/{server}/sites/{site}/tenants/{tenant}/nginx-configuration` | [Update NGINX configuration](https://developers.ploi.io/tenants/update-nginx-configuration-tenant) | `implemented_locally_unverified_live` |
| `monitoring` | `GET` | `/api/servers/{server}/sites/{site}/monitors` | [List all monitors](https://developers.ploi.io/monitoring/list-monitors) | `implemented_locally_unverified_live` |
| `monitoring` | `GET` | `/api/servers/{server}/sites/{site}/monitors/{monitor}` | [Get a monitor](https://developers.ploi.io/monitoring/get-monitor) | `implemented_locally_unverified_live` |
| `monitoring` | `GET` | `/api/servers/{server}/sites/{site}/monitors/{monitor}/uptime-responses` | [Get uptime responses](https://developers.ploi.io/monitoring/get-uptime-responses) | `implemented_locally_unverified_live` |
| `monitoring` | `DELETE` | `/api/servers/{server}/sites/{site}/monitors/{monitor}` | [Delete a monitor](https://developers.ploi.io/monitoring/delete-monitor) | `implemented_locally_unverified_live` |
| `apps` | `POST` | `/api/servers/{server}/sites/{id}/wordpress` | [Install WordPress](https://developers.ploi.io/apps/install-wordpress) | `implemented_locally_unverified_live` |
| `apps` | `DELETE` | `/api/servers/{server}/sites/{id}/wordpress` | [Uninstall WordPress](https://developers.ploi.io/apps/uninstall-wordpress) | `implemented_locally_unverified_live` |
| `apps` | `POST` | `/api/servers/{server}/sites/{id}/nextcloud` | [Install Nextcloud](https://developers.ploi.io/apps/install-nextcloud) | `implemented_locally_unverified_live` |
| `apps` | `DELETE` | `/api/servers/{server}/sites/{id}/nextcloud` | [Uninstall Nextcloud](https://developers.ploi.io/apps/uninstall-nextcloud) | `implemented_locally_unverified_live` |
| `apps` | `POST` | `/api/servers/{server}/sites/{id}/statamic` | [Install Statamic](https://developers.ploi.io/apps/install-statamic) | `implemented_locally_unverified_live` |
| `apps` | `DELETE` | `/api/servers/{server}/sites/{id}/statamic` | [Uninstall Statamic](https://developers.ploi.io/apps/uninstall-statamic) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/complete-install` | [Complete install](https://developers.ploi.io/wordpress-management/complete-install) | `implemented_locally_unverified_live` |
| `wordpress-management` | `GET` | `/api/servers/{server}/sites/{id}/wordpress/plugins` | [List plugins](https://developers.ploi.io/wordpress-management/list-plugins) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/plugins/activate` | [Activate plugin](https://developers.ploi.io/wordpress-management/activate-plugin) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/plugins/deactivate` | [Deactivate plugin](https://developers.ploi.io/wordpress-management/deactivate-plugin) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/plugins/update` | [Update plugin](https://developers.ploi.io/wordpress-management/update-plugin) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/plugins/install` | [Install plugin](https://developers.ploi.io/wordpress-management/install-plugin) | `implemented_locally_unverified_live` |
| `wordpress-management` | `DELETE` | `/api/servers/{server}/sites/{id}/wordpress/plugins/delete` | [Delete plugin](https://developers.ploi.io/wordpress-management/delete-plugin) | `implemented_locally_unverified_live` |
| `wordpress-management` | `GET` | `/api/servers/{server}/sites/{id}/wordpress/themes` | [List themes](https://developers.ploi.io/wordpress-management/list-themes) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/themes/activate` | [Activate theme](https://developers.ploi.io/wordpress-management/activate-theme) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/themes/update` | [Update theme](https://developers.ploi.io/wordpress-management/update-theme) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/themes/install` | [Install theme](https://developers.ploi.io/wordpress-management/install-theme) | `implemented_locally_unverified_live` |
| `wordpress-management` | `DELETE` | `/api/servers/{server}/sites/{id}/wordpress/themes/delete` | [Delete theme](https://developers.ploi.io/wordpress-management/delete-theme) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/toggle-xmlrpc` | [Toggle XML-RPC](https://developers.ploi.io/wordpress-management/toggle-xmlrpc) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/wp-cli/run` | [Run WP-CLI command](https://developers.ploi.io/wordpress-management/run-wp-cli-command) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/search-replace` | [Search & replace](https://developers.ploi.io/wordpress-management/search-replace) | `implemented_locally_unverified_live` |
| `wordpress-management` | `GET` | `/api/servers/{server}/sites/{id}/wordpress/repositories` | [List repositories](https://developers.ploi.io/wordpress-management/list-repositories) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/repositories` | [Install repository](https://developers.ploi.io/wordpress-management/install-repository) | `implemented_locally_unverified_live` |
| `wordpress-management` | `PATCH` | `/api/servers/{server}/sites/{id}/wordpress/repositories/{repository}` | [Update repository](https://developers.ploi.io/wordpress-management/update-repository) | `implemented_locally_unverified_live` |
| `wordpress-management` | `PATCH` | `/api/servers/{server}/sites/{id}/wordpress/repositories/{repository}/deploy-script` | [Update deploy script](https://developers.ploi.io/wordpress-management/update-repository-deploy-script) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/repositories/{repository}/deploy` | [Deploy repository](https://developers.ploi.io/wordpress-management/deploy-repository) | `implemented_locally_unverified_live` |
| `wordpress-management` | `POST` | `/api/servers/{server}/sites/{id}/wordpress/repositories/deploy-all` | [Deploy all repositories](https://developers.ploi.io/wordpress-management/deploy-all-repositories) | `implemented_locally_unverified_live` |
| `wordpress-management` | `DELETE` | `/api/servers/{server}/sites/{id}/wordpress/repositories/{repository}` | [Delete repository](https://developers.ploi.io/wordpress-management/delete-repository) | `implemented_locally_unverified_live` |
| `fastcgi-cache` | `POST` | `/api/servers/{server}/sites/{site}/fastcgi-cache/enable` | [Enable FastCGI cache](https://developers.ploi.io/fastcgi-cache/enable-fastcgi-cache) | `implemented_locally_unverified_live` |
| `fastcgi-cache` | `DELETE` | `/api/servers/{server}/sites/{site}/fastcgi-cache/disable` | [Disable FastCGI cache](https://developers.ploi.io/fastcgi-cache/disable-fastcgi-cache) | `implemented_locally_unverified_live` |
| `fastcgi-cache` | `POST` | `/api/servers/{server}/sites/{site}/fastcgi-cache/flush` | [Flush FastCGI cache](https://developers.ploi.io/fastcgi-cache/flush-fastcgi-cache) | `implemented_locally_unverified_live` |
| `containers` | `GET` | `/api/servers/{server}/docker/containers` | [List all containers](https://developers.ploi.io/containers/list-containers) | `implemented_locally_unverified_live` |
| `containers` | `GET` | `/api/servers/{server}/docker/containers/{container}` | [Retrieve a container](https://developers.ploi.io/containers/get-container) | `implemented_locally_unverified_live` |
| `containers` | `POST` | `/api/servers/{server}/docker/containers` | [Create a new container](https://developers.ploi.io/containers/create-container) | `implemented_locally_unverified_live` |
| `containers` | `PATCH` | `/api/servers/{server}/docker/containers/{container}` | [Update a container](https://developers.ploi.io/containers/update-container) | `implemented_locally_unverified_live` |
| `containers` | `DELETE` | `/api/servers/{server}/docker/containers/{container}` | [Delete a container](https://developers.ploi.io/containers/delete-container) | `implemented_locally_unverified_live` |
| `containers` | `POST` | `/api/servers/{server}/docker/containers/{container}/up` | [Start a container](https://developers.ploi.io/containers/start-container) | `implemented_locally_unverified_live` |
| `containers` | `POST` | `/api/servers/{server}/docker/containers/{container}/down` | [Stop a container](https://developers.ploi.io/containers/stop-container) | `implemented_locally_unverified_live` |
| `containers` | `GET` | `/api/servers/{server}/docker/containers/{container}/logs` | [Get container logs](https://developers.ploi.io/containers/container-logs) | `implemented_locally_unverified_live` |
| `containers` | `POST` | `/api/servers/{server}/docker/containers/{container}/site/link` | [Link site to container](https://developers.ploi.io/containers/link-site) | `implemented_locally_unverified_live` |
| `containers` | `DELETE` | `/api/servers/{server}/docker/containers/{container}/site/unlink` | [Unlink site from container](https://developers.ploi.io/containers/unlink-site) | `implemented_locally_unverified_live` |
